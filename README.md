...
<tbody>
	<tr>
		<td>01</td>
		<td>&lt;html&gt<br><xmp>...</xmp><br><xmp></html></xmp&gt</td>
		<td>HTML документ - обязательный</td>
	</tr>
	
	<tr>
	    <td>02</td>
	    <td><xmp><head&gt<br><xmp>...</xmp><br><xmp></head></xmp&gt</td>
	...
	<tr>
	    <td>03</td>
	    <td><xmp><body&gt<br><xmp>...</xmp><br><xmp></body&gt
	    <td>
	        <ul>
    ...
    <tr>
        <td>04</td>
        <td><xmp><hr&gt</td>
        <td>рисует горизонтальную линию, которая по своему виду зависит от используемых параметров, а также браузера. Тег <xmp><hr&gt относится к блочным элементам, линия всегда начинается с новой строки, а после нее все элементы отображаются на следующей строке</td>
    </tr>
    ...
    <tr>
        <td>13</td>
        <td><xmp><ul&gt<br><xmp><li>...</li&gt<br><xmp></ul&gt</td>
        <td>тег <xmp><ul&gt устанавливает маркированный список. Каждый элемент списка должен начинаться с тега <xmp><li&gt. Если к тегу <xmp><ul&gt применяется таблица стилей, то элементы <xmp><li&gt наследуют эти свойства</td>
    </tr>
    ...
    <tr>
        <td>16</td>
        <td><xmp><big>...</big&gt</td>
        <td>увеличивает размер шрифта на единицу по сравнению с обычным текстом, допускается применение вложенных тегов <xmp><big&gt, при этом размер шрифта будет больше с каждым уровнем</td>
    </tr>
    
    <tr>
        <td>17</td>
        <td><xmp><small>...</small&gt</td>
        <td>уменьшает размер шрифта на единицу по сравнению с обычным текстом, допускается применение вложенных тегов <xmp><small&gt, при этом размер шрифта будет меньше с каждым вложенным уровнем, но не может быть меньше, чем 1</td>
    </tr>
